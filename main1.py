...
try:
    ...
    departure_city = driver.find_element(By.XPATH, "/html/body/div[3]/div[1]/div[5]/div/div[1]/div/div[2]/div[1]/div[1]/input")
    departure_city.clear()
    departure_city.send_keys("Сочи")
    time.sleep(1)
    ...
    arrival_city = driver.find_element(By.XPATH,"/html/body/div[3]/div[1]/div[5]/div/div[1]/div/div[2]/div[3]/div[1]/input")
    arrival_city.send_keys("Москва")
    time.sleep(1)
    ...
    date_of_dispatch = driver.find_element(By.XPATH,"/html/body/div[3]/div[1]/div[5]/div/div[1]/div/div[2]/div[4]/div[1]/input")
    ...
    return_date = driver.find_element(By.XPATH,"/html/body/div[3]/div[1]/div[5]/div/div[1]/div/div[2]/div[6]/div[1]/input")
    ...
    a = driver.find_element(By.XPATH, '/html/body/div[3]/div/div[3]/div/div[2]/div[1]/div/div/div/div[1]/div[1]/div[1]')
    time.sleep(5)
